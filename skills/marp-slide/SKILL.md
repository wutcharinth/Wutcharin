---
name: marp-slide
description: Create professional, visually appealing Marp presentation slides with 7 pre-designed themes and built-in best practices.
---
...
6. Save to the project directory with `.md` extension
...
7. **Output file**
   - Save with descriptive filename like `presentation.md`
...
## File Output
Save the final Marp file to the project directory with `.md` extension:
- `presentation.md`
- `seminar-slides.md`
