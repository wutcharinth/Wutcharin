    ...
    return (
        <section id="contact" className="py-20 px-4 relative overflow-hidden bg-bg border-t-4 border-border">
            <div className="max-w-4xl mx-auto text-center relative z-10">
                ...
                >
                    <h2 className="text-6xl font-black mb-8 uppercase tracking-tighter">Let's <span className="text-inverse-text bg-inverse px-4">Connect</span></h2>
                    ...
                    <div className="flex flex-col md:flex-row justify-center gap-6">
                        <a
                            ...
                            className="flex items-center justify-center gap-3 px-8 py-4 bg-bg border-4 border-border hover:bg-inverse hover:text-inverse-text transition-all group shadow-[8px_8px_0px_0px_var(--shadow-color)] hover:shadow-none hover:translate-x-[4px] hover:translate-y-[4px]"
                        >
